...
def merge_separate_dirs(
    ...
    """
    if input_dir.resolve() == outputs_dir.resolve():
        return input_dir
...
def _verify_xbeach_simulation_minimal_requirements(
    ...
    # If output_format is None or an empty string, assume default
    if not output_format:
        output_format = DEFAULT_OUTPUT_FORMAT

    # If output_format still doesn't match expected, reject
